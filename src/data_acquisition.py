...
def capture_signal(output_file='data/raw/signal.npy', duration=5, sample_rate=2.4e6, center_freq=100e6):
    """
...
if __name__ == "__main__":
    ...
    capture_signal(output_file=args.output, duration=args.duration, sample_rate=args.sample_rate, center_freq=args.freq)
